...
export async function main() {
    ...
    window.addEventListener("load", async function () {
            ...
            .on("click", function () {
                ...
                if (d3.select(this).classed("focused")) {
                    ...
                    rule_rhs.forEach(r2 => {
                        ...
                        d3.selectAll(f).style("opacity", "1").style("stroke", '#e78ac3')
                    })
                    rule_lhs.forEach(r => {
                        ...
                        console.log(f)
                        d3.selectAll(f).style("opacity", "1").style("stroke", '#1a9850')
        ...
        d3.selectAll(containers).style('stroke', '#e6f2ff')
            .style('opacity', '1')
        ...
        d3.selectAll(texts)
            ...
            .on("click", function () {
                ...
                if (d3.select(this).classed("focused")) {
                    ...
                    d3.selectAll(texts).style("opacity", "1")
                    d3.selectAll(containers).style("opacity", "1").style('stroke', '#e6f2ff')
                    d3.selectAll(circles).style("opacity", "1")
        ...
        d3.selectAll(containers2).style('stroke', '#e6f2ff')
        ...
        d3.selectAll(texts2)
            ...
            .on("click", function () {
                ...
                if (d3.select(this).classed("focused")) {
                    ...
                    d3.selectAll(containers2).style("opacity", "1").style('stroke', '#e6f2ff')
        ...
        .on("click", function () {
            ...
            if (d3.select(this).classed("focused")) {
                ...
                rule_rhs.forEach(r2 => {
                    ...
                    $(`#${text_name2}`).css("opacity", "1")
                    $(`.${out_r}`).css("opacity", "1").css("stroke", '#e78ac3').css("stroke-width", '0.75')
                ...
                rule_lhs.forEach(r => {
                    ...
                    console.log(in_r)
                    $(`.${in_r}`).css("opacity", "1").css("stroke", '#1a9850').css("stroke-width", '0.75')
                    $(`#${text_name}`).css("opacity", "1")
                })
