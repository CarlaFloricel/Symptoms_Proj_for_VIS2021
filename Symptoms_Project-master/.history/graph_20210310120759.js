...
export async function main() {
    ...
    window.addEventListener("load", async function () {
        ...
        .on("click", function () {
            ...
            //         const out_r2 = "out2_" + id + " in2_" + r2
            //         console.log(out_r2)
            //         const f2 = l.getElementsByClassName(out_r2)
            //         console.log(f2)
            //         $(`#${text_name2}`).css("opacity", "1")

            //         d3.selectAll(f2).style("opacity", "1").style("stroke", 'orange')
            //     })
            //     rule_lhs.forEach(r => {
            //         const text_name = r + "_late_text"
            //         const container_name = r + "_late_symp"
            //         const in_r2 = "out2_" + r + " in2_" + id
            //         const f3 = l.getElementsByClassName(in_r2)
            //         d3.selectAll(f3).style("opacity", "1").style("stroke", 'blue')
            //         $(`#${text_name}`).css("opacity", "1")
            //     })
            ...
            if (d3.select(this).classed("focused")) {
                ...
                $(`.in2_${id}`).css("opacity", "1")
                $(`.out2_${id}`).css("opacity", "1")
                rule_rhs.forEach(r2 => {
                    const text_name2 = r2 + "_late_text"
                    const out_r = "in2_" + r2 + " out2_" + id
                    const f = l.getElementsByClassName(out_r)
                    $(`#${text_name2}`).css("opacity", "1")
                    d3.selectAll(f).style("opacity", "1").style("stroke", 'orange')
                })
                ...
                d3.selectAll(containers2).style("opacity", "1")
                d3.selectAll(circles2).style("opacity", "1")
                d3.selectAll(arrows2).style("opacity", "1").style("stroke", "#aaaaaa")
            }
