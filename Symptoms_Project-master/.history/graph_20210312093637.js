...
export async function main() {
    ...
    window.addEventListener("load", async function () {
        ...
        d3.selectAll(containers).style('stroke', '#fee0b6')
            .style('opacity', '1')
        ...
        d3.selectAll(texts)
            ...
            .on("click", function () {
                ...
                if (d3.select(this).classed("focused")) {
                    ...
                    d3.selectAll(texts).style("opacity", "1")
                    d3.selectAll(containers).style("opacity", "1").style('stroke', '#fee0b6')
                    d3.selectAll(circles).style("opacity", "1")
        ...
        d3.selectAll(containers2).style('stroke', '#fee0b6')
        ...
        d3.selectAll(texts2)
            ...
            .on("click", function () {
                ...
                if (d3.select(this).classed("focused")) {
                    ...
                    d3.selectAll(containers2).style("opacity", "1").style('stroke', '#fee0b6')
