...
export async function main() {
    ...
    window.addEventListener("load", async function () {
                ...
                if(d3.select(this).classed("focused")){
                   ...
                   const rule_confidence = rule.map(e => e["confidence"])[0]
                    ...
                    //  d3.selectAll(containers).style("opacity", "0.2")
                      ...
                      rule_rhs.forEach(r2 => {
                        console.log(r2)
                     const text_name2= r2+"_symp_text"
                     const container_name2=r2+"_symp"
                   ...
                   rule_lhs.forEach(r => {
                    ...
                    //   console.log(f)
                      d3.selectAll(f).style("opacity", "1")
                      const f2 = document.getElementsByClassName(container_name)
                      console.log(f2)
                      $(`#${container_name}`).css("opacity", "1")
                   })
        ...
        d3.selectAll(arrows)
            ...
            $(`#sadness_acute_symp`).css("color", "black")
