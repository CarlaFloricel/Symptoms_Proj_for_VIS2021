...
export async function main() {
    ...
    window.addEventListener("load", async function () {
        ...
        var symptoms = l.getElementsByClassName('graph_symptom_container')
        ...
        d3.selectAll(circles)
            ...
            .on("click", function(){
                ...
                if(d3.select(this).classed("focused")){
                   ...
                   const rule_confidence = rule.map(e => e["confidence"])[0]
                   rule_lhs.forEach(r => {
                    //    symptoms.selectAll("#taste_symp").style("opacity", "0")
                       
                       const el = d3.select("#taste_symp")
                      console.log(el)

                   })
                   var x = document.querySelector("#taste_symp");
                     
                   console.log(symptoms.getElementById("taste_symp"))
