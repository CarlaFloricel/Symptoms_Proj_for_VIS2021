        ...
        .on("click", function () {
            ...
            if (d3.select(this).classed("focused")) {
                ...
                rule_rhs.forEach(r2 => {
                    ...
                    const out_r2 = "in2_" + r2 + " out2_" + id
                    $(`.in_2_${r2} .out_2${id}`).css("opacity", "1").style("stroke", 'orange')
                    // console.log(out_r2)
                    const f = l.getElementsByClassName(out_r2)
                    $(`#${text_name2}`).css("opacity", "1")
                ...
                rule_lhs.forEach(r => {
                    ...
                    const in_r2 = "in2_" + id + " out2_" + r
                    const f = l.getElementsByClassName(in_r2)
                    d3.selectAll(f).style("opacity", "1").style("stroke", 'blue')
                    $(`#${text_name}`).css("opacity", "1")
                })
