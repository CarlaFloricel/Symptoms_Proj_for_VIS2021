          ...
          this.g.append('rect')
            ...
            .attr('id', symp[27-i]+'-rect'+k)
                ...
                if(selected_patient[k].length >0){
                  ...
                  var l = rating == 0? 100+12*k + l1*lmin/2-2  : rating <6 && rating > 0 ? 110+50*k + l1*lmin + l2*lmin/2 -2: rating <10 && rating > 5?  110+50*k + l1*lmin + l2*lmin + l3*lmin/2-2 : 110+50*k + l1*lmin + l2*lmin + l3*lmin +l4*lmin/2-2
