      ...
      this.g_overview= this.svg.append('g')
        ...
        if(patients.length ==1){
          ...
          var patientBackground = patients_complete.find(p => p.patientId == patients[0][0].patientId);
            ...
            this.g.append('text')
            .attr('transform', `translate(${width -25 -15*k},${height-428})`)
            .text(transformPeriod(12*(11-k)))
           ...
           $('#overview0R').html('0')
            ...
            var i4 = 0;
             $('.symptoms-list').on("click", ()=>{
              ...
              var time_ind = time == 0 ? 0 : time == 1 ? 1 : time == 2 ? 2 : time == 3 ? 3 : time == 4 ? 4 : time == 5 ? 5 : time == 6 ? 6 : time == 7 ? 7 : time == 12 ? 12 : time == 24 ? 24 : time == 48 ? 48 : 72;
        ...
        for(var k = 0; k < 12; k ++){
          ...
          for(i=0;i<28; i++){
            ...
            $('#overview0M').html("0W: " +matrixData[0].length  );
            $('#overview6M').html("  1W: " +matrixData[1].length );
            $('#overview12M').html(" 2W: " +matrixData[2].length );
            $('#overview18M').html(" 3W: " +matrixData[3].length  );
            $('#overview24M').html(" 4W: " +matrixData[4].length );
            $('#overview25M').html(" 5W: " +matrixData[5].length );
            // $('#overview0M').html("6W: " +matrixData[0].length  );
            // $('#overview6M').html("  7W: " +matrixData[1].length );
            // $('#overview12M').html(" 6M: " +matrixData[2].length );
            // $('#overview18M').html(" 12M: " +matrixData[3].length  );
            // $('#overview24M').html(" 18M: " +matrixData[4].length );
            // $('#overview25M').html(" 24M: " +matrixData[5].length );

            var time = window.currentPeriod;
            console.log(matrixData)
            var time_ind = time == 0 ? 0 : time == 1 ? 1 : time == 2 ? 2 : time == 33 ? 3 : time == 4 ? 4 : time == 5 ? 5 : time == 6 ? 6 : time == 7 ? 7 : time == 12 ? 8 : time == 24 ? 9 : time == 48 ? 10 : 72
