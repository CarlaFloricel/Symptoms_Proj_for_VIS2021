      ...
      this.g_overview= this.svg.append('g')
        ...
        for(var k = 0; k < 12; k ++){
          ...
          for(i=0;i<28; i++){
            ...
            $('#overview12W').html(" 6M: " +matrixData[8].length );
            $('#overview24W').html(" 12M: " +matrixData[9].length  );
            $('#overview48W').html(" 18M: " +matrixData[10].length );
            $('#overview72W').html(" 24M: " +matrixData[11].length );
