...
class StackedLinePlot {
 ...
 async drawStackPlot(patientId, symptoms) {
  ...
  this.svg.call(tip)
    ...
    if(!$("#show-percentages").is(":checked")){
    text_tooltip = text_tooltip + 'No. of Patients: ' +part_len+ ' out of a total of '+ len+ + "<br />" ;
    text_tooltip = text_tooltip + '0 Rating Values: ' + l1 + "<br />"
    text_tooltip = text_tooltip + '>0 and <6 Rating Values: ' + l2+ "<br />"
    text_tooltip = text_tooltip + '>5 and <10 Rating Values: ' + l3+ "<br />"
    text_tooltip = text_tooltip + '10 Rating Values: ' + l4 + "<br />"
    }
    else{
        part_len = (part_len/len *100).toFixed(2)
        text_tooltip = text_tooltip + 'Percent. of Patients: ' +part_len+ '% out of a total of '+ len+ "<br />" ;
        text_tooltip = text_tooltip + '0 Rating Values: ' + l1 + "<br />" ;
        text_tooltip = text_tooltip + '>0 and <6 Rating Values: ' + l2 + "<br />";
        text_tooltip = text_tooltip + '>5 and <10 Rating Values: ' + l3 + "<br />" ;
        text_tooltip = text_tooltip + '10 Rating Values: ' + l4 + "<br />" ;
