...
class App {
  ...
  init() {
    window.supportlabels =  ["all",'0.20', "0.21", '0.22','0.23','0.24']
    window.currentSupport = 0.20
    window.liftlabels =  ["all",'2.5', "2.54", '2.6','2.7','2.8']
  ...
  async sliderLiftUpdate(){
    console.log(window.currentLift)
...
async sliderSupportUpdate(){
  ...
  if( window.oldSupValue > 1 || window.oldLiftValue > 1){
      ...
      && parseFloat(d['lift']) >= parseFloat(window.liftlabels[window.oldLiftValue-1]) - 0.001 && parseFloat(d['lift']) <= parseFloat(window.liftlabels[window.oldLiftValue-1]) + 0.001
      )
  ...
  async showRules(event){
    ...
    var el = event.target.id
      if(el == 'Late'){
        ...
        window.supportlabels = ["all",'0.20', "0.21", '0.22','0.23','0.26']
        window.liftlabels =  ["all",'2.1', "2.2", '2.3','2.8','2.9']
