...
async sliderSupportUpdate(){
  ...
  if( window.oldSupValue > 1){
    ...
    //  }
      ...
      const rule = data.filter(d => parseFloat(d['support']) >= window.supportlabels[window.oldSupValue-1] - 0.08 && parseFloat(d['support']) <= window.supportlabels[window.oldSupValue-1] + 0.08)()
