...
console.log(window.oldLiftValue)
  if( window.oldSupValue > 1 || window.oldLiftValue > 1){
      ...
      const rules_acute=null
      const rules_late = null
      if(window.oldSupValue > 1 && window.oldLiftValue > 1){
        rules_acute = data_acute.filter(d => parseFloat(d['support']) >= parseFloat(window.supportlabels[window.oldSupValue-1]) - 0.001 && parseFloat(d['support']) <= parseFloat(window.supportlabels[window.oldSupValue-1]) + 0.01
       ...
       rules_late = data_late.filter(d => parseFloat(d['support']) >= parseFloat(window.supportlabels[window.oldSupValue-1]) - 0.001 && parseFloat(d['support']) <= parseFloat(window.supportlabels[window.oldSupValue-1]) + 0.01
      ...
      if(window.oldLiftValue > 1){
        rules_acute = data_acute.filter(d => parseFloat(d['lift']) >= parseFloat(window.liftlabels[window.oldLiftValue-1]) - 0.007 && parseFloat(d['lift']) <= parseFloat(window.liftlabels[window.oldLiftValue-1]) + 0.09)
       rules_late = data_late.filter(d =>  parseFloat(d['lift']) >= parseFloat(window.liftlabels[window.oldLiftValue-1]) - 0.08 && parseFloat(d['lift']) <= parseFloat(window.liftlabels[window.oldLiftValue-1]) + 0.08)
      }
