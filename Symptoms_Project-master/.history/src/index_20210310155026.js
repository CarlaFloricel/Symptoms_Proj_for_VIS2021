...
async sliderSupportUpdate(){
  ...
  if( window.oldSupValue > 1){
    ...
    //  }
      ...
      const rule = data.filter(d => parseFloat(d['support']) >= parseFloat(window.supportlabels[window.oldSupValue-1]) - 0.008 && parseFloat(d['support']) <= parseFloat(window.supportlabels[window.oldSupValue-1]) + 0.008)
       console.log( rule)
