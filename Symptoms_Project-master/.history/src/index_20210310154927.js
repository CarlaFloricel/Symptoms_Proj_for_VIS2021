...
async sliderSupportUpdate(){
  ...
  if( window.oldSupValue > 1){
    ...
    //  }
      ...
      const rule = data.filter(d => parseFloat(d['support']) >= parseFloat(window.supportlabels[window.oldSupValue-1]) - 0.08 && parseFloat(d['support']) <= parseFloat(window.supportlabels[window.oldSupValue-1]) + 0.08)()
       console.log( window.supportlabels[window.oldSupValue-1])
