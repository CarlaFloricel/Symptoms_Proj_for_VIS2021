    ...
    if (!data.length) {
      ...
      patients.forEach((p, i) => {
        ...
        const radialData = currentPatient.map(t => {
          ...
          if(timeIndex > 0){
            // const difff = parseInt(t['period']) - parseInt(currentPatient[timeIndex]['period']) 
            console.log(parseInt(currentPatient[timeIndex-1]['period']))
            console.log(parseInt(t['period']))
          }
