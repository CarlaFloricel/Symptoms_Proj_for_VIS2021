...
async sliderSupportUpdate(){
  ...
  if( window.oldSupValue > 1 || window.oldLiftValue > 1){
      ...
      // parseFloat(d['support']) >= parseFloat(window.supportlabels[window.oldSupValue-1]) - 0.001 && parseFloat(d['support']) <= parseFloat(window.supportlabels[window.oldSupValue-1]) + 0.01
      // && 
