      ...
      this.g_overview= this.svg.append('g')
        ...
        for(var k = 0; k < 12; k ++){
          ...
          for(i=0;i<28; i++){
            ...
            $('#overview6W').html("6W: " +matrixData[0].length  );
            $('#overview7W').html("  7W: " +matrixData[1].length );
            $('#overview12W').html(" 6M: " +matrixData[2].length );
            $('#overview18W').html(" 12M: " +matrixData[3].length  );
            $('#overview24W').html(" 18M: " +matrixData[4].length );
            $('#overview72W').html(" 24M: " +matrixData[5].length );
