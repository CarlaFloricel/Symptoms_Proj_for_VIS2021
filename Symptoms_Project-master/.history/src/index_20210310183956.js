...
class App {
  constructor() {
    ...
    this.initLiftSlider = this.initLiftSlider.bind(this)
    this.patientFilters = [];
  ...
  async initLifSlider() {
    ...
    this.liftSlider = new SuppoortSlider('#support-slider',window.liftlabels, await this.sliderLiftUpdate);
  ...
  init() {
    ...
    window.liftlabels =  ['0.5', "0.5", '0.62','0.23','0.24']
